...
// account[2].cartList.push(new CartItem(2, 104300, 2, null, '../ProductPage/img/galaxy-note-20-ultra(1).jpg'));
// account[2].cartList.push(new CartItem(4, 160000, 5, null, '../ProductPage/img/galaxy-z-fold3(1).jpg'));
// account[2].cartList.push(new CartItem(5, 160000, 15, null, '../ProductPage/img/galaxy-s21-plus(1).jpg'));
